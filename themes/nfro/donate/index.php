...
<?php if (Flux::config('AcceptDonations')): ?>
	...
	<p>By donating, you're supporting the costs of <em>running</em> this server and <em>maintaining</em> it.  In return, you will be rewarded <span class="keyword" style="color:#333;"><br>donation credits</span> that you may use to purchase items from our <a href="<?php echo $this->url('purchase') ?>">item shop</a>.</p>
	...
	<div class="generic-form-div" style="margin-bottom: 10px;width: 400px;">
